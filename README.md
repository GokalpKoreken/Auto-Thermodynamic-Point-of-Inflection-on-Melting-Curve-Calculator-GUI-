...
6.Fit a Fourrier Series Function because the graph that left is almost a straight line and the best fit  possible can be achieved by using Fourrier Fitting. 7.Take the First and Second Derrivatives of the function that been fitted. 8.Find where the second derrivative does a zero-crossing. 9.Plot the results
